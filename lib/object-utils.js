        ...
        if (!fileCoverage.l) {
            ...
            Object.keys(statements).forEach(function (st) {
                try {
                    ...
                    //console.log("Code coverage failure in object-utils line 62.");
                    //console.log("Statement: " + st);
                    //console.log("Statement map: " + JSON.stringify(statementMap));
                    //console.log("Statements: " + JSON.stringify(statements));
                    //console.log("File coverage obj: " + JSON.stringify(fileCoverage));
                    console.log(e);
                    delete statements[st];
                    delete statementMap[st];
                }
            });
        }
    }
