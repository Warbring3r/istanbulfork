    ...
    Instrumenter.prototype = {
                ...
                fixer = function (loc) {
                    if (loc.start.line === 1) {
                        try {
                            ...
                            //console.log("Code coverage failure in instrumenter.js line 616");
                            console.log(e);
                        }
                    }
                    if (loc.end.line === 1) {
        ...
        statementName: function (location, initValue) {
            ...
            try {
                ...
                //console.log("Code coverage failure in instrumenter.js line 746");
                console.log(e);
            }
        ...
        coverFunction: function (node, walker) {
            ...
            try {
                ...
                //console.log("Code coverage failure in instrumenter.js line 857");
                console.log(e);
            }
        ...
        branchName: function (type, startLine, pathLocations) {
            ...
            for (i = 0; i < pathLocations.length; i += 1) {
                if (!pathLocations[i]) {
                    console.log("Missing path location " + i);
                    continue;
                }
        ...
        ifBranchInjector: function (node, walker) {
            ...
            try {
                ...
                //console.log("Code coverage failure in instrumenter.js line 928");
                console.log(e);
            }
        ...
        switchCaseInjector: function (node) {
            ...
            if (this.maybeSkipNode(node, 'next')) {
                if (!location)
                    console.log("Missing location on line 978 of instrumenter.js");
                location.skip = true;
            }
        },
        ...
        maybeAddSkip: function (branchLocation) {
            return function (node) {
                ...
                if (ignoreThis || alreadyIgnoring) {
                    if (!branchLocation)
                        console.log("Missing branchLocation on line 1005 of instrumenter.js");
